...
if (!isset($_POST["update_fail"])) { // from admin_query_student/admin.php
  $clienttype = $_GET["clienttype"];

  // Get the username, fetch the record to be updated from the database 
  ...
  // Sql string changes depending on if admin / student / admin student
